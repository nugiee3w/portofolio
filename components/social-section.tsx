...
const instagramPosts = [
  { image: "/images/bts-workspace.png", likes: "Ruang Kerja" },
  { image: "/images/bts-conference.png", likes: "Berbicara" },
  { image: "/images/bts-code.png", likes: "Fokus Penuh" },
  { image: "/images/bts-team.png", likes: "Kolaborasi" },
  { image: "/images/bts-laptop.png", likes: "Lembur" },
  { image: "/images/bts-hackathon.png", likes: "Hackathon" },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter mt-2 overflow-hidden">
            <span className="inline-block">COLLEGE&nbsp;</span>
            <span className="text-[#AFFF00] inline-block">MOMENT</span>
          </h2>
        </motion.div>
          ...
          {instagramPosts.map((post, index) => (
            ...
            >
              <Image
                ...
                alt={`Foto di balik layar ${index + 1}`}
                fill
        ...
        >
          <motion.a
            href="https://instagram.com/alexmercer.dev"
            target="_blank"
          ...
          >
            ...
            <span className="relative z-10">@alexmercer.dev</span>
          </motion.a>
        </motion.div>
      </div>
    </section>
