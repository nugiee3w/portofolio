...
const flavors = [
  {
    ...
    tagline: "React · Next.js · Stripe",
    description: "Dashboard analitik real-time untuk toko online dengan pelacakan penjualan langsung, manajemen inventaris, dan pembayaran Stripe.",
  ...
  {
    id: 2,
    name: "Aplikasi Mobile Fitness",
    tagline: "React Native · Node.js",
    description: "Pelacak latihan lintas platform dengan program yang dipersonalisasi, grafik perkembangan, dan sinkronisasi offline.",
    image: "/images/project-mobile.png",
    bgColor: "from-[#f59e0b]/20 via-[#f59e0b]/10 to-transparent",
    accentColor: "#f59e0b",
    stack: ["React Native", "Node.js", "PostgreSQL", "Expo"],
  },
  {
    id: 3,
    name: "Platform Analitik SaaS",
    tagline: "Next.js · Postgres · AI",
    description: "Platform analitik multi-tenant dengan dashboard, papan kanban, dan wawasan bertenaga AI.",
    image: "/images/project-saas.png",
    bgColor: "from-[#AFFF00]/20 via-[#AFFF00]/5 to-transparent",
    accentColor: "#AFFF00",
    stack: ["Next.js", "Drizzle", "AI SDK", "Vercel"],
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#121212] tracking-tighter mt-2 overflow-hidden">
            <span className="inline-block">PROYEK&nbsp;</span>
            <span className="inline-block" style={{ color: currentFlavor.accentColor }}>
              SAYA
            </span>
          </h2>
        </motion.div>
